...
This project uses Mistral for AI-assisted development. Follow the canonical instructions in [`docs/ai-instructions.md`](docs/ai-instructions.md) before changing code in this repository.
